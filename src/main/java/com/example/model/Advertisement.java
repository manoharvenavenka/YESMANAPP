...
////////////////////////////////////////////////////////////
	...
	public List<Advertisement> getAllAdv(){
		List<Advertisement> complainlist=new ArrayList<Advertisement>();
		...
		try {
		    ...
		    while(rs.next()) {
		    	Advertisement Book= new Advertisement();
		    	
		    	
		    	Book.setAdvertisementStartDate(rs.getString("advertisementStartDate"));
		    	Book.setAdvertisementEndDate(rs.getString("advertisementEndDate"));
		    	Book.setAdvertisementId(rs.getInt("advertisementId"));
		    	Book.setWorkerId(rs.getInt("workerId"));
		    	Book.setAdvertisementBanner(rs.getString("advertisementBanner"));
